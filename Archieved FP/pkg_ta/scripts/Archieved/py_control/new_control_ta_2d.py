...
# waypoints_np = np.load('waypoints/waypoints/08_09_wp_S.npy')
# waypoints_np = np.load('waypoints/waypoints/08_09_wp_belok.npy')
# waypoints_np = np.load('waypoints/waypoints/08_09_wp_belok_besar.npy')
