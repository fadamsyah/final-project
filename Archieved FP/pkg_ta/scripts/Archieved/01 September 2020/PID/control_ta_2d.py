...
# waypoints_np = np.load('waypoints/waypoints/01_09_wp_lurus.npy')
# waypoints_np = np.load('waypoints/waypoints/01_09_wp_S.npy')
# waypoints_np = np.load('waypoints/waypoints/01_09_wp_belok.npy')
waypoints_np = np.load('waypoints/waypoints/01_09_wp_belok_besar.npy')
