...
from lib_ta_py.controller_TA_v2 import Controller_v1
import rospy
...
freq = 20 # Hz
waypoints_np = np.load('waypoints/waypoints/28_08_lurus.npy')
# waypoints_np = np.load('waypoints/waypoints/28_08_belok.npy')
# waypoints_np = np.load('waypoints/waypoints/28_08_S.npy')
...
max_brake = 2.8; max_throttle = 0.25; min_throttle = 0.08
